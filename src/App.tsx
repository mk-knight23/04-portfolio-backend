...
const selectedProjects = [
    { name: 'API Gateway', category: 'Backend', tech: 'Node.js', description: 'Centralized authentication serving 10K+ requests daily with 99.9% uptime' },
    { name: 'Ecommerce Platform', category: 'Full Stack', tech: 'Java / React', description: 'Handling 50K+ SKUs with distributed caching and payment integrations' },
    { name: 'Student Portal API', category: 'Backend', tech: 'Python', description: 'Serving 100K+ students across 5+ institutions with sub-100ms response times' },
    { name: 'Real-time Chat Engine', category: 'Backend', tech: 'Socket.io', description: 'Supporting 10K+ concurrent connections with message persistence' }
];

const skillsByCategory = {
    'Backend Engineering': ['Node.js', 'Python', 'Java', 'PostgreSQL', 'Redis', 'Microservices'],
    'Cloud & Infrastructure': ['RESTful APIs', 'GraphQL', 'AWS / GCP', 'Docker', 'Kubernetes'],
    'Security & Compliance': ['OAuth2', 'JWT', 'Encryption', 'RBAC', 'Audit Systems'],
    'System Architecture': ['System Design', 'Scalability', 'Event-Driven', 'CI/CD', 'Monitoring']
};
        ...
        <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
            ...
            <section className="min-h-screen flex items-center bg-slate-900 relative overflow-hidden">
                ...
                >
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <span className="text-amber-400 text-sm font-medium tracking-wider uppercase">Backend Engineer & System Architect</span>
                    </div>
            ...
            <section id="about" className="py-20 px-8 bg-white">
                ...
                >
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="text-sm font-semibold text-amber-600 tracking-wider uppercase">Professional Background</span>
                    </div>
                    <h2 className="text-4xl font-bold mb-8 text-slate-900">About Me</h2>
                    <div className="prose prose-lg text-slate-600">
                        <p className="mb-6 leading-relaxed">
                            Backend Engineer and System Architect specializing in <strong className="text-slate-900">Distributed Systems</strong>,
                            <strong className="text-slate-900"> API Design</strong>,
                            <strong className="text-slate-900"> Database Optimization</strong>, and
                            <strong className="text-slate-900"> Cloud Infrastructure</strong>.
                        </p>
                        <p className="mb-6 leading-relaxed">
                            Currently serving as a <span className="text-amber-600 font-semibold">Project Engineer (TURBO)</span> at <strong>Wipro</strong>,
                            where I engineer scalable backend architectures and mission-critical services for enterprise clients.
                        </p>
                        <p className="leading-relaxed">
                            Experienced in <strong className="text-slate-900">System Design</strong>,
                            <strong className="text-slate-900"> Performance Tuning</strong>,
                            <strong className="text-slate-900"> DevOps Automation</strong>, and
                    ...
                    <div className="grid grid-cols-3 gap-8 mt-16 pt-12 border-t border-slate-200">
                        ...
                        <div className="text-center">
                            ...
                            <div className="text-sm text-slate-500 mt-2 font-medium">Years Experience</div>
                        </div>
                    </div>
                </motion.div>
            </section>
                ...
                >
                            ...
                            >
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-slate-500 text-sm font-medium mb-2">{product.tagline}</p>
                    ...
                    <div className="p-8 bg-slate-900 rounded-xl">
                        ...
                        <div className="grid sm:grid-cols-2 gap-4">
                            {[
                                { icon: '🏗️', text: 'Hierarchical RAG (H-RAG) + Decision Agents' },
                                { icon: '🔀', text: 'Multi-provider LLM routing with fallback' },
                                { icon: '📋', text: '55-feature roadmap with 4-tier prompts' },
                                { icon: '📊', text: 'Competitive analysis across 60 tools' },
                                { icon: '📦', text: 'Monorepo strategy with ecosystem boundaries' },
            ...
            <section id="work" className="py-20 px-8 bg-white">
                <motion.div
                    ...
                    className="max-w-6xl mx-auto"
                >
                    <h2 className="text-4xl font-bold mb-4 text-slate-900">Backend Portfolio</h2>
                    <p className="text-slate-600 mb-12 text-lg">Architecture-driven projects and enterprise system implementations.</p>
                    ...
                    >
                        View All 60 Projects <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                    </a>
                </motion.div>
            </section>
            ...
            <section id="skills" className="py-20 px-8 bg-slate-50">
                ...
                >
                    ...
                    <p className="text-slate-600 mb-12 text-lg">Specializing in enterprise backend engineering and cloud infrastructure.</p>
            ...
            <section id="resume" className="py-20 px-8 bg-white">
                ...
                >
                    ...
                    <p className="text-slate-600 mb-12 text-lg">Backend Engineer & System Architect</p>
                    ...
                    <div className="grid lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-10">
                            {/* Experience */}
                            <div>
                                <h3 className="text-lg font-semibold text-slate-900 mb-6 pb-2 border-b border-slate-200">Experience</h3>
                                <div className="space-y-6">
                                    <div className="pl-6 border-l-2 border-amber-400">
                                        <div className="flex items-start justify-between mb-2">
                                            <h4 className="text-lg font-semibold text-slate-900">Project Engineer (TURBO)</h4>
                                            <span className="text-sm text-slate-500 font-medium">Jul 2022 – Present</span>
                                        </div>
                                        <p className="text-amber-600 font-medium mb-2">Wipro</p>
                                        <p className="text-slate-600 leading-relaxed">
                                            Architecting scalable backend systems, REST APIs, and microservices. Building enterprise-grade
                                            infrastructure with Node.js, Python, and Java. Delivering high-performance solutions
                                            for 99.9%+ uptime and handling 100K+ daily requests.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {/* Education */}
                            <div>
                                <h3 className="text-lg font-semibold text-slate-900 mb-6 pb-2 border-b border-slate-200">Education</h3>
                                <div className="pl-6 border-l-2 border-slate-300">
                                    <div className="flex items-start justify-between mb-2">
                                        <h4 className="text-lg font-semibold text-slate-900">B.Tech Computer Science & Engineering</h4>
                                        <span className="text-sm text-slate-500 font-medium">2022</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-10">
                            {/* Tech Stack */}
                            <div>
                                <h3 className="text-lg font-semibold text-slate-900 mb-6 pb-2 border-b border-slate-200">Tech Stack</h3>
                                <div className="space-y-4">
                                    <div>
                                        <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Languages</p>
                                        <div className="flex flex-wrap gap-2">
                                            {['Node.js', 'Python', 'Java', 'TypeScript', 'Go'].map((tech) => (
                                                <span key={tech} className="px-3 py-1 bg-slate-100 text-slate-700 rounded text-sm">
                                                    {tech}
                                                </span>
                                            ))}
                                        </div>
                                    ...
                                    <div>
                                        <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Infrastructure</p>
                                        <div className="flex flex-wrap gap-2">
                                            {['PostgreSQL', 'MongoDB', 'Redis', 'Docker', 'Kubernetes', 'AWS'].map((tech) => (
                                                <span key={tech} className="px-3 py-1 bg-slate-100 text-slate-700 rounded text-sm">
                                                    {tech}
                                                </span>
                                            ))}
            ...
            <section id="what-ill-build" className="py-20 px-8 bg-slate-100">
                ...
                >
                    ...
                    <h2 className="text-4xl font-bold mb-4 text-slate-900">What I’ll Work On</h2>
                    <p className="text-slate-600 mb-12 text-lg max-w-2xl">First 3–6 months as your Backend Engineer</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="p-8 bg-white rounded-xl border border-slate-200">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-3">Infrastructure Audit</h3>
                            <p className="text-slate-600 leading-relaxed">
                                Analyze existing backend systems, database schemas, and API architecture. Identify bottlenecks,
                                security vulnerabilities, and scalability limits. Create a prioritized roadmap for improvements.
                            </p>
                        </div>
                        ...
                        <div className="p-8 bg-white rounded-xl border border-slate-200">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-3">API & Data Layer</h3>
                            <p className="text-slate-600 leading-relaxed">
                                Design RESTful/GraphQL APIs with proper error handling, authentication, and rate limiting.
                                Optimize database queries, implement caching strategies, and ensure data consistency.
                            </p>
                        </div>
                        ...
                        <div className="p-8 bg-white rounded-xl border border-slate-200">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-3">Scalability & Reliability</h3>
                            <p className="text-slate-600 leading-relaxed">
                                Implement microservices architecture, message queues for async processing, and circuit breakers.
                                Set up monitoring, alerting, and disaster recovery procedures.
                            </p>
                        </div>
                        ...
                        <div className="p-8 bg-white rounded-xl border border-slate-200">
                            ...
                            <h3 className="text-xl font-semibold text-slate-900 mb-3">DevOps & Deployment</h3>
                            <p className="text-slate-600 leading-relaxed">
                                Build CI/CD pipelines, container orchestration with Docker/Kubernetes, and automated testing.
                                Ensure zero-downtime deployments with quick rollback capabilities.
                            </p>
                        </div>
                    </div>
                </motion.div>
            ...
            <section id="contact" className="py-20 px-8 bg-slate-900">
                ...
                >
                    ...
                    <p className="text-slate-400 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
                        Open to senior backend engineering, distributed systems architecture, and technical leadership opportunities.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                        ...
                        <span className="px-5 py-3 bg-slate-800 rounded-lg text-sm">
                            ...
                            <span className="text-emerald-400 font-semibold">Remote & Hybrid</span>
                        </span>
                    </div>
